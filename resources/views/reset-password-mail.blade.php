                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi {{$data1['user']}},</h1>
                        <p>You recently requested to reset your password for your ACEVERIFY account. Use the button below to reset it.</p>  <p> <strong>This password reset is only valid for the next 24 hours.</strong></p>
                        <!-- Action -->
